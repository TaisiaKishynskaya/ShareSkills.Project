...
namespace App.Services.RecommendationSystem.Test
{
    ...
    public class TeacherRatingService
    {
        ...
        public TeacherRatingService(FakeAppDbContext context)
        {
            _context = context;
...
/*public class FakeAppDbContext
{
    public List<ClassTimeEntity> ClassTimes { get; }
    public List<LevelEntity> Levels { get; }
    public List<SkillEntity> Skills { get; }
    public List<TeacherEntity> Teachers { get; }
    public List<StudentEntity> Students { get; }
    public List<TeacherRatingEntity> TeacherRatings { get; }

    public readonly Guid MainStudentId = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa");

    public FakeAppDbContext()
    {
        // Расписания
        ClassTimes = new List<ClassTimeEntity>
        {
            new ClassTimeEntity { Id =  Guid.Parse("00000000-0000-0000-0000-000000000001"), Name = "Morning" },
            new ClassTimeEntity { Id =  Guid.Parse("00000000-0000-0000-0000-000000000002"), Name = "Afternoon" },
            new ClassTimeEntity { Id =  Guid.Parse("00000000-0000-0000-0000-000000000003"), Name = "Evening" }
        };

        // Уровни
        Levels = new List<LevelEntity>
        {
            new LevelEntity { Id = Guid.Parse("00000000-0000-0000-0000-000000000011"), Name = "Beginner" },
            new LevelEntity { Id = Guid.Parse("00000000-0000-0000-0000-000000000012"), Name = "Intermediate" },
            new LevelEntity { Id = Guid.Parse("00000000-0000-0000-0000-000000000013"), Name = "Advanced" }
        };

        // Навыки
        Skills = new List<SkillEntity>
        {
            new SkillEntity { Id = Guid.Parse("00000000-0000-0000-0000-000000000021"), Skill = "C#" },
            new SkillEntity { Id = Guid.Parse("00000000-0000-0000-0000-000000000022"), Skill = "Python" },
            new SkillEntity { Id = Guid.Parse("00000000-0000-0000-0000-000000000023"), Skill = "ML.NET" }
        };

        // Преподаватели
        Teachers = new List<TeacherEntity>
        {
            new TeacherEntity { Id = Guid.Parse("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                ClassTimeId = ClassTimes[0].Id, LevelId = Levels[1].Id, SkillId = Skills[2].Id },

            new TeacherEntity { Id = Guid.Parse("cccccccc-cccc-cccc-cccc-cccccccccccc"),
                ClassTimeId = ClassTimes[0].Id, LevelId = Levels[1].Id, SkillId = Skills[2].Id },

            new TeacherEntity { Id = Guid.Parse("dddddddd-dddd-dddd-dddd-dddddddddddd"),
                ClassTimeId = ClassTimes[1].Id, LevelId = Levels[1].Id, SkillId = Skills[2].Id },

            new TeacherEntity { Id = Guid.Parse("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"),
                ClassTimeId = ClassTimes[0].Id, LevelId = Levels[2].Id, SkillId = Skills[2].Id },

            new TeacherEntity { Id = Guid.Parse("ffffffff-ffff-ffff-ffff-ffffffffffff"),
                ClassTimeId = ClassTimes[2].Id, LevelId = Levels[1].Id, SkillId = Skills[2].Id },

            new TeacherEntity { Id = Guid.Parse("11111111-1111-1111-1111-111111111111"),
                ClassTimeId = ClassTimes[0].Id, LevelId = Levels[1].Id, SkillId = Skills[0].Id },

            new TeacherEntity { Id = Guid.Parse("22222222-2222-2222-2222-222222222222"),
                ClassTimeId = ClassTimes[1].Id, LevelId = Levels[0].Id, SkillId = Skills[0].Id },

            new TeacherEntity { Id = Guid.Parse("33333333-3333-3333-3333-333333333333"),
                ClassTimeId = ClassTimes[2].Id, LevelId = Levels[2].Id, SkillId = Skills[0].Id },

            new TeacherEntity { Id = Guid.Parse("44444444-4444-4444-4444-444444444444"),
                ClassTimeId = ClassTimes[0].Id, LevelId = Levels[1].Id, SkillId = Skills[1].Id },

            new TeacherEntity { Id = Guid.Parse("55555555-5555-5555-5555-555555555555"),
                ClassTimeId = ClassTimes[1].Id, LevelId = Levels[2].Id, SkillId = Skills[1].Id }
        };
        ...
        Students = new List<StudentEntity>
        {
            ...
            {
                Id = MainStudentId,
                Purpose = "Learn ML.NET",
                UserId = default
            }
        };

        // Оценки преподавателей этим студентом
        TeacherRatings = new List<TeacherRatingEntity>
        {
            new TeacherRatingEntity
            {
                Id = Guid.NewGuid(),
                StudentId = MainStudentId,
                TeacherId = Guid.Parse("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), // ML.NET, Intermediate, Morning
                Rating = 5
            },
            new TeacherRatingEntity
            {
                Id = Guid.NewGuid(),
                StudentId = MainStudentId,
                TeacherId = Guid.Parse("11111111-1111-1111-1111-111111111111"), // C#, Intermediate, Morning
                Rating = 2
            }
        };
    }
